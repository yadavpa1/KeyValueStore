...
// Global variable for number of partitions
int num_partitions = 4; // You can adjust this as per your system configuration
...
void test_availability_with_failures_of_leaders(const std::string& config_file, int keys_to_test) {
    ...
    // But then all the stirngs generated are same
    // What else to do?
